...
int main() {
    ...
    Objetos *objeto15=new Pociones("lañaña", "MANA", 50);
    Objetos *objeto16=new Pociones("lañaravilla","SALUD",50);
    ...
    Hechizos *hechizo8=new Hechizos(20, "AGUA", "Tsunami");
    Hechizos *hechizo9=new Hechizos(10, "AIRE", "Brisa");
    Hechizos *hechizo10=new Hechizos(20, "FUEGO", "Volcan");
    *personaje>>objeto>>objeto2>>objeto15>>objeto16;
    *personaje2>>objeto2>>objeto3>>objeto12;
    if(Mago *tmp=dynamic_cast<Mago*>(personaje)) *tmp>>hechizo>>hechizo8>>hechizo9>>hechizo10;
    ...
    Objetos *objeto17=new Pociones("Elbrebaje","SALUD",35);
    ...
    Hechizos *hechizo6=new Hechizos(20, "AGUA", "Limpiador");
    Hechizos *hechizo7=new Hechizos(20, "AIRE", "Ventisca");
    Hechizos *hechizo11=new Hechizos(50, "TIERRA", "Terremoto");
    *personaje3>>objeto4>>objeto5>>objeto11>>objeto17;
    *personaje4>>objeto5>>objeto6>>objeto10;
    if(Mago *tmp=dynamic_cast<Mago*>(personaje3)) *tmp>>hechizo2>>hechizo6>>hechizo7>>hechizo11;
    ...
    Objetos *objeto18=new Pociones("Lasanadora","SALUD",70);
    ...
    Hechizos *hechizo4=new Hechizos(20, "FUEGO", "lamarada");
    Hechizos *hechizo5=new Hechizos(20, "AIRE", "Huracan");
    Hechizos *hechizo12=new Hechizos(30, "TIERRA", "Rotura");
    *personaje5>>objeto7>>objeto8>>objeto13>>objeto18;
    *personaje6>>objeto8>>objeto9>>objeto14;
    if(Mago *tmp=dynamic_cast<Mago*>(personaje5)) *tmp>>hechizo3>>hechizo4>>hechizo5>>hechizo12;
    ...
    Lista_Objetos.push_back(objeto15);
    Lista_Objetos.push_back(objeto16);
    Lista_Objetos.push_back(objeto17);
    Lista_Objetos.push_back(objeto18);
    Lista_Hechizos.push_back(hechizo2);
    Lista_Hechizos.push_back(hechizo3);
    Lista_Hechizos.push_back(hechizo);
    Lista_Hechizos.push_back(hechizo4);
    Lista_Hechizos.push_back(hechizo5);
    Lista_Hechizos.push_back(hechizo6);
    Lista_Hechizos.push_back(hechizo7);
    Lista_Hechizos.push_back(hechizo8);
    Lista_Hechizos.push_back(hechizo9);
    Lista_Hechizos.push_back(hechizo10);
    Lista_Hechizos.push_back(hechizo11);
    Lista_Hechizos.push_back(hechizo12);
    Lista_Personajes.push_back(personaje);
    Lista_Personajes.push_back(personaje2);
    Lista_Personajes.push_back(personaje3);
    Lista_Personajes.push_back(personaje4);
    Lista_Personajes.push_back(personaje5);
    Lista_Personajes.push_back(personaje6);
